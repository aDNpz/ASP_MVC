...
namespace QTSchool.CodeGenApp
{
    ...
    internal partial class Program
    {
        ...
        private static void RunApp()
        {
            ...
            {
                Console.Clear();
                Console.WriteLine($"Code generation for: {nameof(QTSchool)}");
                Console.WriteLine("=============================================");
                Console.WriteLine();
        ...
        private static string GetCurrentSolutionPath()
        {
            int endPos = AppContext.BaseDirectory
                                   .IndexOf("QTSchool.CodeGenApp", StringComparison.CurrentCultureIgnoreCase);
