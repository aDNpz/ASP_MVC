...
namespace QTSchool.Logic.DataContext
{
    ...
    {
#if SQLSERVER_ON
        private static readonly string ConnectionString = "Data Source=(localdb)\\MSSQLLocalDB;Database=QTSchoolDb;Integrated Security=True";
#endif
#if SQLITE_ON
        private static readonly string ConnectionString = "Data Source=/Users/gerhardgehrer/Projects/Data/QTSchool.db";
#endif
        /// <summary>
